...
List<String> list =new ArrayList<>();
		...
		// istenen indexdeki elemani kaldirip, yerine bizim istedigimiz koyar.(replace)
		...
		// list.add(10,"Sefer"); cok ileri hata verir.size dan buyuk
		
	System.out.println(	list.contains("Hurriyet")); //True
	System.out.println(	list.contains("Mehmet"));	//false
	
	list.contains("Cemal"); // Ölü bir kod,liste degismez
